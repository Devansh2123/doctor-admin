...
const Navbar = () => {
  ...
  return (
    <div className='panel-topbar sticky top-0 z-20 flex justify-between items-center px-3 sm:px-6 py-3 backdrop-blur border-b'>
      <div className='flex items-center gap-2 text-xs'>
        <img onClick={() => navigate('/')} className='w-36 sm:w-56 cursor-pointer' src={adminHeaderLogo} alt="Neuronet Systems Logo" />
